...
# Python Project GUI Color Picker
# Prakash Kumar
...
id1 = colors1.create_rectangle((10,10,50,50),fill="#b82558")
...
hex1=Label(colors1,text="#b82558",fg="#000",font="arial 12 bold",bg="white")
hex1.place(x=60,y=15)

hex2=Label(colors1,text="#db4035",fg="#000",font="arial 12 bold",bg="white")
hex2.place(x=60,y=65)

hex3=Label(colors1,text="#ff9933",fg="#000",font="arial 12 bold",bg="white")
hex3.place(x=60,y=115)

hex4=Label(colors1,text="#fad000",fg="#000",font="arial 12 bold",bg="white")
hex4.place(x=60,y=165)

hex5=Label(colors1,text="#afb83b",fg="#000",font="arial 12 bold",bg="white")
